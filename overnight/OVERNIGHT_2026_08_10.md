...
- **#62 — NEXT (unblocked by #64).** Remove the NW-crop luxury double-count on the CORRECTED geography, per DESIGN_NWCROP_DEMAND_RECLASSIFY_62 (already reviewed). Implementing next.
