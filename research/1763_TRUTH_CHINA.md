# 1763 SOURCE OF TRUTH — CHINA (Qing, high-fidelity)

**Purpose:** The authoritative reference for the #234 pop+ownership audit of Qing China — the mod's FOCUS region (fine historical fidelity + granularity). Snapshot: Feb 1763, mid-Qianlong.
**Companion:** `1763_TRUTH_ROW.md` (rest of world, good-enough abstraction).
**Trust rule:** Claims graded [MONOGRAPH]/[PRIMARY]/[ESTIMATE]/[WEAK] by source strength. Prior game-work/CSV owner columns are NOT sources. Consolidated from research/ (Ho Ping-ti, Cao Shuji, Rowe, Perdue, Liang Fangzhong).
**Scale:** 4000 people = 1 map unit.
...
### Named institutions on SUBJECT soil (1763) — for building-seeding, by city [MONOGRAPH-grade]
Sources: Perdue, *China Marches West* (2005); Millward, *Beyond the Pass* (1998) & *Eurasian Crossroads* (2007); Elliott, *The Manchu Way* (2001); Crossley, *The Manchus* (1997); Goldstein, *A History of Modern Tibet* (1989); Berger, *Empire of Emptiness* (2003); Deuchler, *The Confucian Transformation of Korea* (1992); Smits, *Visions of Ryukyu* (1999). The crux is the **dependency-vs-direct-rule** distinction — seed only what stood on a *subject's* soil.
- **Tibet (Ü-Tsang protectorate)** — Gelug sees: **Lhasa** cluster (Drepung ~7,700 monks 1763, Sera, Ganden, Jokhang, Potala) + **Tashilhunpo at Shigatse** (Panchen Lama's seat, founded 1447). Amban compound (駐藏大臣衙門) + ~1,000 banner troops at Lhasa (dual-amban from 1750s). No Confucian institutions, no tuntian.
- **Outer Mongolia (Khalkha)** — Gelug: **Erdene Zuu** at Karakorum (founded 1585, ~60 temples by 1760s), **Amarbayasgalant** (1727–37). ⚠️ **Urga/Ikh Khüree was only a SEASONAL encampment of the Jebtsundamba in 1763** — its FIXED monastic city is post-1763 (permanence ~1778–79); do NOT seed a monastery *building* at Urga for a 1763 start. Banner garrisons: **Uliastai** (定邊左副將軍 from 1733), **Khovd** (科布多參贊大臣 from 1731). Limited garrison-provisioning tuntian only.
- **Manchuria (three generalships — banner homeland, NOT tributary; distinct from the 18 provinces)** — banner-general yamen: **Mukden/Shengjing** (盛京將軍), **Jilin city** (吉林將軍衙門, relocated from Ningguta **1757**), **Qiqihar** (黑龍江將軍衙門, from 1690s). Extensive banner tuntian (八旗屯田). A Qing *state* Confucian temple at Mukden (not a tributary-court institution).
- **Xinjiang (Ili generalship 1762)** — banner garrisons: **Huiyuan** (伊犁將軍衙門, 1762; the "Nine Cities of Ili" under construction 1762–65), **Ürümqi/Dihua** (迪化 military prefecture 1763), amban seats at **Kashgar/Yarkand/Khotan/Aksu** (from 1759). ⚠️ **Institutionally BLANK for Gelug monasteries in 1763** — the Dzungar destruction (1755–59) wiped out earlier Oirat Buddhist infrastructure; Qing re-seeding is 1760s–70s+. Extensive banner + Uyghur tuntian in the Ili valley and Ürümqi.
- **Korea (Joseon, ritual tributary)** — Confucian: **Seonggyungwan/Munmyo (成均館/文廟)** national academy at Hanseong + the great **seowon (書院)** (Sosu, Dosan, Byeongsan, Oksan, Piram). No Qing garrison, no Gelug, no tuntian (fully autonomous).
- **Vietnam (Lê–Trịnh, ritual tributary)** — Confucian: **Văn Miếu / Quốc Tử Giám (文廟)** at **Thăng Long/Hanoi** (founded 1070) — in the **Trịnh-controlled north** (the court the Qing recognized as "Annam"), NOT the Nguyễn south (Huế). No Gelug, no garrison, no tuntian. *[Mod caveat: the 1763 setup splits Vietnam into VIE (Nguyễn, capital Huế 2593) and TRH (Trịnh, north, holds Hanoi 3418); only VIE is a CHI subject in setup.]*
- **Ryukyu (dual tributary)** — Confucian: **Shiseibyō (至聖廟)** + Meirintō academy at **Kumemura/Naha** (the Fujianese scholar-bureaucrat quarter). No Gelug, no garrison, no tuntian.
- **Kham feudatories** — **Derge**: Gönchen monastery (更慶寺, 1448) is **Sakya, NOT Gelug**, + the Derge Parkhang printing house (德格印經院) — on feudatory soil. Chamdo (Jampa Ling, Gelug 1437) under Lhasa amban purview. ⚠️ **Labrang (Gansu) and Kumbum/Ta'er (Qinghai) are in DIRECTLY-RULED Qing provinces, NOT feudatory soil** — often confused with Kham; do not treat as subject territory.
